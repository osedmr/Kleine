    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launchWhenStarted {
            billingViewModel.address.collectLatest {
                when(it) {
                    ...
                    is Resource.Error ->{
                        binding.progressbarAddress.visibility=View.GONE
                        Toast.makeText(requireContext(),"Yükleme Hatası",Toast.LENGTH_LONG).show()
                    }
                    else -> Unit
                }
            }
                ...
                when(it) {
                    ...
                    is Resource.Success ->{
                       binding.buttonPlaceOrder.revertAnimation()
                        ...
                        Snackbar.make(requireView(),"Your order was places",Snackbar.LENGTH_LONG).show()
                    }
                    is Resource.Error ->{
                        binding.progressbarAddress.visibility=View.GONE
                        Toast.makeText(requireContext(),"Yükleme Hatası",Toast.LENGTH_LONG).show()
        ...
        binding.buttonPlaceOrder.setOnClickListener {
           if (selectedAddress == null){
               Toast.makeText(requireContext(),"lütfen adresi seçiniz",Toast.LENGTH_LONG).show()
